...
/**
 * Define the interface of a class with methods and attributes.
 */

public class ObjectInterface extends JavaInterface {
	 ...
	 */
	public ObjectInterface(String className) throws ClassNotFoundException {
		rowLength = 0;
		...
		for (int i = 0; i < methods.length; i++) {
			...
			MemberLine memberLine = new MemberLine(name, stringClassParameters, methodReturnType);
